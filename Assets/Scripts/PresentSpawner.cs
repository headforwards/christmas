...
public class PresentSpawner : MonoBehaviour
{
    ...
    void stopPresents(string arg)
    {
        spawnPresents = false;
    }

    void startPresents(string arg)
    {
        spawnPresents = true;
    }
    ...
    void OnEnable()
    {
        EventManager.StartListening(EventNames.StopPresents, stopPresents);
        EventManager.StartListening(EventNames.StartPresents, startPresents);
    }

    void OnDisable()
    {
        EventManager.StopListening(EventNames.StopPresents, stopPresents);
        EventManager.StopListening(EventNames.StartPresents, startPresents);
    }
}
